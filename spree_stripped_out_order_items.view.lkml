view: spree_stripped_out_order_items {
  derived_table: {
    sql: select * from sales.order_items where reason_to_strip_out is not null ;;
  }
  ...
  measure: total_items_returned_size {
    ...
    filters: {
      field: return_reason
      value: "It's too small, It's too large"
    }
  }
  ...
  measure: total_items_returned_not_as_pictured_not_as_described {
    ...
    filters: {
      field: return_reason
      value: "It's not as described, It's not as pictured"
    }
  }
  ...
  measure: total_items_returned_faulty {
    ...
    filters: {
      field: return_reason
      value: "It's faulty/in a poor condition"
    }
  }
  ...
  measure: total_items_returned_ordered_more_than_1_size {
    ...
    filters: {
      field: return_reason
      value: "I ordered more than one size"
    }
  }
