- dashboard: marketing_report
  ...
  - name: marketing_kpi_yesterday
    ...
    explore: sessions
    type: table
    fields: [sessions.channel_grouping_3, sessions.visits_yesterday, sessions.orders_yesterday,
      sessions.conversion_yesterday, sessions.sum_gross_revenue_ex_discount, sessions.average_basket_ex_discount_yesterday]
    fill_fields: [sessions.channel_grouping_3]
    filters:
      session_start_calendar.calendar_date_date: 1 days ago for 1 days
    sorts: [sessions.sum_gross_revenue_ex_discount desc]
