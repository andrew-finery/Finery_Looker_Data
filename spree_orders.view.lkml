view: spree_orders {
  ...
  measure: gross_cogs_yesterday {
   ...
   measure: gross_cogs_yesterday_last_week {
    label: "LW"
    type: number
    sql: sum(case when ${completed_date} = current_date - 8 then gross_cogs_gbp_yesterday_last_week else 0 end) ;;
  ...
  measure: gross_cogs_yesterday_last_year {
    label: "LY"
    type: number
    sql: sum(case when (${completed_date} = (select calendar_date from finery.calendar where week_number = (select week_number from finery.calendar where calendar_date = current_date - 1) and dow = (select dow from finery.calendar where calendar_date = current_date - 1) and year = (select year - 1 from finery.calendar where calendar_date = current_date - 1))) then gross_cogs_yesterday_last_year else 0 end) ;;
    value_format_name: pounds_k
    group_label: "Gross Cogs Reporting Measures"
  }
  ...
  measure: gross_cogs_month_to_date {
    label: "MTD"
    type: number
    sql: sum(case when ${completed_date} between date_trunc('month', current_date - 1) and current_date - 1 then gross_cogs_month_to_date else 0 end) ;;
    value_format_name: pounds_k
  ...
  measure: gross_cogs_month_to_date_last_month {
    label: "MTD LM"
    type: number
    sql: sum(case when ${completed_date} between date_trunc('month', add_months(current_date - 1, -1)) and add_months(current_date - 1, -1) then gross_cogs_month_to_date_last_month else 0 end) ;;
    value_format_name: pounds_k
    group_label: "Gross Cogs Reporting Measures"
  }
  ...
  measure: gross_cogs_month_to_date_last_year {
    label: "MTD LY"
    type: number
    sql: sum(case when ${completed_date} between date_trunc('month', add_months(current_date - 1, -12)) and add_months(current_date - 1, -12) then gross_cogs_month_to_date_last_year else 0 end) ;;
    value_format_name: pounds_k
    group_label: "Gross Cogs Reporting Measures"
  }
  ...
  measure: gross_cogs_year_to_date {
    label: "YTD"
    type: number
    sql: sum(case when ${completed_date} between date_trunc('year', current_date - 1) and current_date - 1 then gross_cogs_year_to_date else 0 end) ;;
    value_format_name: pounds_k
    group_label: "Gross Cogs Reporting Measures"
  }
  ...
  measure: gross_cogs_year_to_date_last_year {
    label: "YTD LY"
    type: number
    sql: sum(case when ${completed_date} between date_trunc('year', add_months(current_date - 1, -12)) and add_months(current_date - 1, -12) then gross_cogs_year_to_date_last_year else 0 end) ;;
    value_format_name: pounds_k
    group_label: "Gross Cogs Reporting Measures"
  }
