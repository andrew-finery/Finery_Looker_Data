- dashboard: facebook_api_placement
  ...
  - name: avg_relevance_score
    ...
    dimensions: [facebook_api_ad_performance_breakdown.calendar_date]
    pivots: [facebook_api_ad_performance_breakdown.placement_general]
    measures: [facebook_api_ad_performance_breakdown.avg_relevance_score]
    filters:
      facebook_api_ad_performance_breakdown.calendar_date: 30 days ago for 30 days
    sorts: [facebook_api_ad_performance_breakdown.avg_relevance_score desc]
    limit: 500
    stacking: ''
    colors: ['#5245ed', '#ed6168', '#1ea8df', '#353b49', '#49cec1', '#b3a0dd', '#db7f2a',
      '#706080', '#a2dcf3', '#776fdf', '#e9b404', '#635189']
  ...
  - name: avg_frequency
    ...
    dimensions: [facebook_api_ad_performance_breakdown.calendar_date]
    pivots: [facebook_api_ad_performance_breakdown.placement_general]
    measures: [facebook_api_ad_performance_breakdown.avg_frequency]
    filters:
      facebook_api_ad_performance_breakdown.calendar_date: 30 days ago for 30 days
    sorts: [facebook_api_ad_performance_breakdown.avg_frequency desc]
    limit: 500
    stacking: ''
    colors: ['#5245ed', '#ed6168', '#1ea8df', '#353b49', '#49cec1', '#b3a0dd', '#db7f2a',
      '#706080', '#a2dcf3', '#776fdf', '#e9b404', '#635189']
