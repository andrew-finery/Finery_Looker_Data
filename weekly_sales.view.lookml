...
########################################################################################################################################################################################
  ...
  - dimension: product_sold_tw
    type: yesno
    sql: ${TABLE}.items_sold_tw > 0
...
#########################################################################################################################################################################################################
 ...
 # THIS WEEK LAST YEAR measures
  ...
  - measure: options_online_sold_tw
    type: count_distinct
    sql: ${product_lookup.option_name}
    filters:
      product_sold_tw: yes
  ...
  - measure: zero_selling_options_tw
    type: number
    decimals: 1
    sql: 100.0 * (${options_online_tw} - ${options_online_sold_tw})/NULLIF(${options_online_tw},0)::REAL
    format: "%0.2f%"
...
################################################################## MIX measures #################################################################################################
  ...
  - measure: sales_mix_tw
    type: percent_of_total
    sql: ${sum_gross_item_revenue_gbp_ex_vat_tw}
  
  - measure: stock_mix_tw
    type: percent_of_total
    sql: ${sum_stock_value_cost_gbp_tw}
  
  - measure: gross_margin_mix_tw
    type: percent_of_total
    sql: ${sum_gross_profit_gbp_tw}
