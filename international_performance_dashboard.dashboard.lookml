- dashboard: international_performance_dashboard
  ...
  - name: uk_orders
    title: UK performance - Orders
    model: finery_data
    explore: spree_orders
    type: table
    fields: [spree_addresses.country_group, spree_orders.orders_yesterday, spree_orders.orders_yesterday_last_week,
      spree_orders.orders_week_to_date, spree_orders.orders_week_to_date_last_week,
      spree_orders.orders_week_to_date_last_year, spree_orders.orders_month_to_date,
      spree_orders.orders_month_to_date_last_month, spree_orders.orders_month_to_date_last_year,
      spree_orders.orders_yesterday_last_year, spree_orders.orders_year_to_date, spree_orders.orders_year_to_date_last_year]
    filters:
      spree_addresses.country_group: UK
    sorts: [spree_orders.orders_yesterday desc]
    limit: 100
    column_limit: 50
  ...
  - name: ie_us_orders
    title: Ireland & Us Performance - Orders
    model: finery_data
    explore: spree_orders
    type: table
    fields: [spree_addresses.country_group, spree_orders.orders_yesterday, spree_orders.orders_yesterday_last_week,
  ...
  - name: other_orders
    title: Other Country Performance - Orders
    model: finery_data
    explore: spree_orders
    type: table
    fields: [spree_addresses.country_group, spree_orders.orders_yesterday, spree_orders.orders_yesterday_last_week,
