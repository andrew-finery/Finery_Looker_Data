view: facebook_api_ad_performance_breakdown {
  ...
  dimension: audience_segment {
    sql: case when ${TABLE}.campaign_name like '%Acquisition%' then 'Acquisition'
  ...
  dimension: buyers_vs_nonbuyers {
    sql: case when ${TABLE}.campaign_name not like '%Retention%' and ${TABLE}.campaign_name not like '%Reactivation%' then 'Customer Acquisition'
  ...
  dimension: placement_specific {
    sql: case when ${TABLE}.breakdown like 'News Feed on Desktop Computers' and ${TABLE}.breakdown_type = 'placement' then 'News Feed Desktop'
  ...
  dimension: placement_general {
    sql: case when ${TABLE}.breakdown like '%News Feed on Desktop Computers%' and ${TABLE}.breakdown_type = 'placement' then 'Desktop'
  ...
  dimension: country {
    sql: case when ${TABLE}.breakdown like 'IE' then 'IE'
  ...
  dimension: age {
    sql: case when ${TABLE}.breakdown like '%13-17%' then '13-17'
  ...
  dimension: impression_device {
    sql: case when ${TABLE}.breakdown like '%Desktop%' then 'Desktop'
  ...
  dimension: hourly_stats_aggregated_by_audience_time_zone {
    sql: case when ${TABLE}.breakdown like '00:00:00 - 00:59:59' and ${TABLE}.breakdown_type = 'hourly_stats_aggregated_by_audience_time_zone' then '00:00:00 - 00:59:59'
