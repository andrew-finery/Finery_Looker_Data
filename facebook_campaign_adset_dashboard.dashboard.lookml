- dashboard: facebook_campaign_adset_dashboard
  title: Facebook Campaign Adset Dashboard
  layout: static
  tile_size: 100
  ...
  - name: campaign
    ...
    default_value: 'Buyers DR - Email Lookalikes_NFD - RHS'
    
  elements:

  - name: spend_by_adset
    title: Spend by Adset
    type: looker_column
    model: finery_data
    explore: facebook_daily_ad_performance
  ...
  - name: total_spend_for_campaign
    ...
    pivots: [facebook_daily_ad_performance.adset_name]
    measures: [facebook_daily_ad_performance.total_spend]
    listen:
     date: facebook_daily_ad_performance.calendar_date
     campaign: facebook_daily_ad_performance.campaign_name
