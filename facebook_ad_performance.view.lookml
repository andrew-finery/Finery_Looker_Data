- view: facebook_api_ad_performance
  ...
  - dimension: placement
    sql: |
          case when ${TABLE}.advert_set_name = 'Best Buyers Lookalikes 5% - Desktop' then 'Desktop'
          when ${TABLE}.advert_set_name = 'Best Buyers Lookalikes 5% - Mobile' then 'Mobile'
  ...
  - dimension: advert_substring_name
    sql: |
         ...
         when advert_name like 'Multi%' then substring(advert_name,0,37)
         when advert_name like 'Video%' then substring(advert_name,0,36) end
